...
public class WebOCR {
    ...
    private static final String APPID = "bc997642";
    // 接口密钥(webapi类型应用开通印刷文字识别服务后，控制台--我的应用---印刷文字识别---服务的apikey)
    private static final String API_KEY = "8599746844d32cf930d00790f27a4b55";
    // 是否返回位置信息
    ...
    private static final String PIC_PATH = "/Users/miaoyaogong/tools/09.png";
...
//        byte[] imageByteArray = FileUtil.read(PIC_PATH);
        byte[] imageByteArray = FileUtil.getFileStream("");
    ...
    public static String getContent(String url) throws Exception {
        byte[] imageByteArray = FileUtil.getFileStream(url);
        Map<String, String> header = buildHttpHeader();
        String imageBase64 = new String(Base64.encodeBase64(imageByteArray), "UTF-8");
        String result = HttpUtil.doPost1(WEBOCR_URL, header, "image=" + URLEncoder.encode(imageBase64, "UTF-8"));
        return result;
